package box.lilei.box_client.loading.text;
...
import box.lilei.box_client.loading.ZLoadingBuilder;

import static com.alibaba.fastjson.util.IdentityHashMap.DEFAULT_SIZE;
...
{
    private static final long DURATION_TIME = 666;
    ...
    protected void initParams(Context context)
    {
        ...
        mTextPaint.setColor(R.color.colorDemoLogo);
