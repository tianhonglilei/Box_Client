...
public class NavGoodsAdapter extends MyBaseAdapter<RoadGoods> {
    ...
    protected void convert(RoadGoods roadGoods, MyViewHolder viewHolder, int position) {
        ((TextView)viewHolder.getView(R.id.nav_goods_gv_item_road_num)).setText(""+ roadGoods.getRoadInfo().getRoadIndex());
        ((TextView)viewHolder.getView(R.id.nav_goods_gv_item_max_num)).setText(""+ roadGoods.getRoadInfo().getRoadMaxNum());
        ((TextView)viewHolder.getView(R.id.nav_goods_gv_item_now_num)).setText(""+ roadGoods.getRoadInfo().getRoadNowNum());
        ((TextView)viewHolder.getView(R.id.nav_goods_gv_item_name)).setText(""+ roadGoods.getGoods().getGoodsName()+"("+ roadGoods.getGoods().getGoodsTaste()+")");
